 ...
 */
public final class AndroidBluetoothAdapter implements IBluetoothHandler {
    /**
     ...
     */
    public static ModuleWrapper<AndroidBluetoothAdapter> newInstance(IServiceLocatorCreator serviceLocatorBridge) {
        return new ModuleWrapper<>(new AndroidBluetoothAdapter(serviceLocatorBridge));
    }
     ...
     */
    private AndroidBluetoothAdapter(IServiceLocatorCreator serviceLocatorBridge) {
