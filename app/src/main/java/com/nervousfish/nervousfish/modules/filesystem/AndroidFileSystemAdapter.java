...
public final class AndroidFileSystemAdapter implements IFileSystem {
     ...
     */
    public static ModuleWrapper<AndroidFileSystemAdapter> newInstance(IServiceLocatorCreator serviceLocatorBridge) {
     ...
     */
    private AndroidFileSystemAdapter(IServiceLocatorCreator serviceLocatorBridge) {
