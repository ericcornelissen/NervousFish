...
public final class GsonDatabaseAdapter implements IDatabase {
     ...
     */
    public static ModuleWrapper<GsonDatabaseAdapter> newInstance(IServiceLocatorCreator serviceLocatorBridge) {
     ...
     */
    private GsonDatabaseAdapter(IServiceLocatorCreator serviceLocatorBridge) {
