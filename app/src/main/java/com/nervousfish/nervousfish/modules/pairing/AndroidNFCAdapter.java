...
public final class AndroidNFCAdapter implements INFCHandler {
     ...
     */
    public static ModuleWrapper<AndroidNFCAdapter> newInstance(IServiceLocatorCreator serviceLocatorBridge) {
     ...
     */
    private AndroidNFCAdapter(IServiceLocatorCreator serviceLocatorBridge) {
