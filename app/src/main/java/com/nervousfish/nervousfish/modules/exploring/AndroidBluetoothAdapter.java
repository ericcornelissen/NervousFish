...
public final class AndroidBluetoothAdapter implements IBluetoothHandler {
     ...
     */
    public static ModuleWrapper<AndroidBluetoothAdapter> newInstance(IServiceLocatorBridge serviceLocatorBridge) {
     ...
     */
    private AndroidBluetoothAdapter(IServiceLocatorBridge serviceLocatorBridge) {
