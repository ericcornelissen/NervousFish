Feature: Bluetooth connection service
  ...
  Scenario Outline: Connect with a device from the paired list
  ...
  Scenario Outline: Start up a connection with the partner device already bonded
    Given I have a BluetoothConnectionActivity and don't have an established connection but have made the necessary pairings already
